...
t1 = read.csv('S://Evgeny/1_Sotrovimab/221209_3_time_period_1.csv')
...
data = t1
path = 'S://Evgeny/1_Sotrovimab/PS/1209_3_time_period_10/'
formula_m = formula('Treatment ~ Age+Gender+EthnicCategory+RenalDisease+Mult_high_risk_bin+Moderate_risk_bin+SolidOrganTransplants+Vacc_stcatus_bin+Days_SinceLastVaccination')
treat_col_name = 'Treatment'
confounders = c("Age","Gender","EthnicCategory","RenalDisease","Mult_high_risk_bin","Moderate_risk_bin","SolidOrganTransplants","Vacc_stcatus_bin","Days_SinceLastVaccination")
estimand_m = 'ATE'
