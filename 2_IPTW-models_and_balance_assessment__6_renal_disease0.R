...
t1 = read.csv('S://Evgeny/1_Sotrovimab/221209_6_renal_disease_0.csv')
...
data = t1
path = 'S://Evgeny/1_Sotrovimab/PS/1209_6_renal_disease_0/'
formula_m = formula('Treatment ~ Age+Gender+EthnicCategory+Time_period+Mult_high_risk_bin+Moderate_risk_bin+SolidOrganTransplants+Vacc_stcatus_bin+Days_SinceLastVaccination')
treat_col_name = 'Treatment'
confounders = c("Age","Gender","EthnicCategory","Time_period","Mult_high_risk_bin","Moderate_risk_bin","SolidOrganTransplants","Vacc_stcatus_bin","Days_SinceLastVaccination")
estimand_m = 'ATE'
